...
const Working = () => (
  <main class="how-it-works">
    <section class="hero">
      <div>
        <h1 class="title">How FileDrop works</h1>
    ...
    <div class="body-wrapper">
      <section class="step">
        <div class="info">
          <h2>Start by joining a block</h2>
          <p>
            A block is a collection of users among which you want to send/receive files.
            Blocks in FileDrop can be thought of as group chats in messaging apps. Each user in a block
            must have a unique name for them to correctly join the block.
          </p>
          <p>
            All your previously joined rooms show up in
            <a href="/app/"> Recent Blocks </a>
            page for quick access in the future.
            These rooms itself are not persisted on any database and are immediately destroyed once all the users of that block leave.
          </p>
        </div>
        <img src={joinRoom} alt="Joining a block in FileDrop" />
      </section>

      <section class="step">
        <img src={sendFile} alt="Sending files in FileDrop" loading="lazy" />
        <div class="info">
          <h2>
            Send a file!
          ...
          <p>
            Sending a file is easy in FileDrop. Just click on the 'Send File' button at the bottom right and choose the files that you
            want to send. Once the files are selected, they would be shared with all the other users in that block.
          </p>
          <p>
            FileDrop uses
          ...
          <p>
            Do note that if the sender of a file leaves the block and the file isn't transferred to any user yet, the file transfer
      ...
      <section class="step">
        <div class="info">
          <h2>Next steps</h2>
          <p>
            If you enjoyed using FileDrop, you can add FileDrop to your home screen! Doing this
            not only makes FileDrop easy to access but also allows it shows up in the share tray when you are sharing something from other apps
            using <Share2 size={20} /> button.
          </p>
          <p>
            FileDrop has been tested on:
            <ul class="browsers">
              <li>
                <img src={chrome} />
        ...
        <img src={install} alt="Adding FileDrop to home screen" loading="lazy" />
      </section>
